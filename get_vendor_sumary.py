...
logging.basicConfig(
    filename="logs/get_vendor_sumary.log",
    level=logging.DEBUG,
...
def clean_data(df):
    ...
    df['ProfitMargin'] = ((df['GrossProfit'] / df['TotalSalesDollars']) * 100).fillna(0)
...
if __name__ == '__main__':
    try:
        ...
        summary_df = create_vendor_sumary(connection)
        ...
        logging.exception("Pipeline failed due to error", {e})